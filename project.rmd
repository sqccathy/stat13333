...
```{r}
# Finding Rc for different numbers of nodes, each with 1000 simulations
...
# Finding the seed for four of 1000 node configurations corresponding roughly to the min, median, mean, and maximum values of Rc50
SimTime = numeric(4)
