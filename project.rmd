...
```{r}
#find the max,min,median,mean of Rc50 and reproduce it.
SimTime = numeric(4)
...
## Finding the points between which the distances are less than or equal to the Rc found using the function findRc.
for(i in 1:4) {
